...
static ConVar r_worldlight_castshadows("r_worldlight_castshadows", "1", FCVAR_CHEAT, "Permite generar sombras dinamicas a partir de las luces del mapa.", true, 0, true, 1, WorldLightCastShadowCallback);
static ConVar r_worldlight_lerptime("r_worldlight_lerptime", "0.3", FCVAR_CHEAT, "Tiempo de actualización de las sombras.");
static ConVar r_worldlight_debug("r_worldlight_debug", "0", FCVAR_CHEAT);
static ConVar r_worldlight_shortenfactor("r_worldlight_shortenfactor", "0.5" , FCVAR_CHEAT, "Makes shadows cast from local lights shorter");
