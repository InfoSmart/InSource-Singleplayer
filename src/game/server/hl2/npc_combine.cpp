...
#define CAPABILITIES	bits_CAP_MOVE_GROUND | bits_CAP_INNATE_MELEE_ATTACK1 | bits_CAP_AIM_GUN | bits_CAP_MOVE_CLIMB | bits_CAP_TURN_HEAD | bits_CAP_SQUAD | bits_CAP_USE_WEAPONS | bits_CAP_DUCK | bits_CAP_NO_HIT_SQUADMATES
#define BLOOD			BLOOD_COLOR_RED
#define SEE_DIST		8000
...
#define COMBINE_AE_CAUGHT_ENEMY		(10)
...
//=========================================================
// InputLookOff()
// No mirar, solo obtener información del escuadron.
//=========================================================
...
//=========================================================
// InputLookOn()
// Activar el seguir al escuadron.
//=========================================================
...
//=========================================================
// InputHitByBugbait()
// Ha sido golpeado por el bugbait
//=========================================================
...
// Lanzar mi granada/bola de energía al objetivo indicado.
//=========================================================
void CNPC_Combine::InputThrowGrenadeAtTarget(inputdata_t &inputdata)
{
	// Ignorar si se esta ejecutando una secuencia.
...
//=========================================================
// Spawn()
// Crear un nuevo Combine
//=========================================================
void CNPC_Combine::Spawn()
{
