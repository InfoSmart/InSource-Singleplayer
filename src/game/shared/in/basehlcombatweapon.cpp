...
CHLMachineGun::CHLMachineGun()
{
	...
	if ( g_pGameRules->IsMultiplayer() && !GetOwner() )
		m_bEnableGlow = true;
	else
		m_bEnableGlow = false;
}
...
#ifdef GAME_DLL
void CHLMachineGun::SetGlow(bool state, Color glowColor)
{
...
#else
void CHLMachineGun::PostDataUpdate(DataUpdateType_t updateType)
{
...
const Vector &CHLMachineGun::GetBulletSpread()
{
...
//
//-----------------------------------------------------------------------------
void CHLMachineGun::PrimaryAttack()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHLMachineGun::ItemPostFrame()
{
...
float CHLSelectFireMachineGun::GetBurstCycleRate()
{
...
float CHLSelectFireMachineGun::GetFireRate()
{
	switch( m_iFireMode )
	{
...
bool CHLSelectFireMachineGun::Deploy()
{
...
//
//-----------------------------------------------------------------------------
void CHLSelectFireMachineGun::PrimaryAttack()
{
	if (m_bFireOnEmpty)
	{
		return;
...
//
//-----------------------------------------------------------------------------
void CHLSelectFireMachineGun::SecondaryAttack()
{
	// change fire modes.
...
//
//-----------------------------------------------------------------------------
void CHLSelectFireMachineGun::BurstThink()
{
