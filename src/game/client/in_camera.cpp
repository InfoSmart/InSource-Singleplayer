...
ConVar cam_idealyaw( "cam_idealyaw", "-0.924042", FCVAR_ARCHIVE );	 // thirdperson yaw
ConVar cam_idealpitch( "cam_idealpitch", "0.000000", FCVAR_ARCHIVE );	 // thirperson pitch
static ConVar cam_idealdist( "cam_idealdist", "100", FCVAR_ARCHIVE );	 // thirdperson distance
