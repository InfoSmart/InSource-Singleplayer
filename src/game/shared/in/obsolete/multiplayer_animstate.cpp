...
int CMultiPlayerAnimState::SelectWeightedSequence( Activity activity )
{
...
#ifndef CLIENT_DLL
	Anim_StatePrintf( iLine++, "Main: %s, Activity: %s, Cycle: %.2f\n", GetSequenceName(GetBasePlayer()->GetModelPtr(), GetBasePlayer()->GetSequence()), ActivityList_NameForIndex(m_pPlayerActivity), GetBasePlayer()->GetCycle() );
#else
