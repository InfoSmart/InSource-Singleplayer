...
#include "ihtmlview.h" // InSource - HTML VIEW
...
void VGui_CreateGlobalPanels( void )
{
	...
	VPANEL gameParent = enginevgui->GetPanel( PANEL_INGAMESCREENS  ); // InSource
	VPANEL gameUiDll = enginevgui->GetPanel( PANEL_GAMEUIDLL ); // InSource
