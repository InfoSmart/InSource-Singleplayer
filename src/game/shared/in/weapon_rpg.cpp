...
public:
	...
	CBaseEntity *GetTargetEntity() { return m_hTargetEnt; }
...
unsigned int CMissile::PhysicsSolidMaskForEntity() const
{ 
...
//-----------------------------------------------------------------------------
bool CWeaponRPG::WeaponShouldBeLowered()
{
...
// Output : Vector
//-----------------------------------------------------------------------------
Vector CWeaponRPG::GetLaserPosition()
{
	CreateLaserPointer();
...
// Purpose: 
//-----------------------------------------------------------------------------
const Vector &CWeaponRPG::GetNPCLaserPosition()
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponRPG::CreateLaserPointer()
{
	if ( m_hLaserDot != NULL )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRPG::NotifyRocketDied()
{
	m_hMissile = NULL;
...
//-----------------------------------------------------------------------------
void CWeaponRPG::StartLaserEffects()
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
	if ( pOwner == NULL )
		return;
...
//-----------------------------------------------------------------------------
void CWeaponRPG::StopLaserEffects()
{
	if ( m_hLaserBeam != NULL )
	{
...
//-----------------------------------------------------------------------------
void CWeaponRPG::UpdateLaserEffects()
{
	if ( !m_bGuiding )
		return;
