...
public:
	...
	virtual void			ReloadInIdle();							// AP - Recarga de arma en estado de descanso.
	virtual void			SetReloadTime(float time);				// AP - Actualizar tiempo de recarga.
	virtual float			GetReloadTime();						// AP - Obtener tiempo de recarga.
	virtual bool			ReloadTimeElapsed();					// AP - Obtener si el arma esta descansando para la recarga.
...
public:
	...
	CNetworkVar(float, m_flReloadTime); // Apocalypse - Tiempo de recarga automatica.
